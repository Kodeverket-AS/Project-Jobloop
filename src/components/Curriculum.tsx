  ...
  return (
    ...
    >
      <h2
        id='curriculum-title'
        className='
          text-kv-black text-2xl md:text-3xl font-bold border-b-4 pb-3
          border-jobloop-primary-green w-fit mx-auto text-center mb-8
        '
      >
        {t('title', { subject: title || "<missing title>"})}
      </h2>
      <div className='
        prose prose-lg max-w-none text-gray-700 leading-relaxed mx-auto
      '>
