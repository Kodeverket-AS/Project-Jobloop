...
export function LesMerButton({ Path, Text = 'Les mer', Aria = '' }: Partial<ButtonProps>) {
  ...
  return (
    <a
      ...
      aria-label={Aria}
      className={`
        w-full md:w-auto md:max-w-[155px] inline-flex items-center justify-center gap-3 px-6 py-3 bg-jobloop-primary-green text-white rounded-full hover:bg-jobloop-primary-orange hover:shadow-lg transition-all duration-300 group/btn hover:scale-105
      `}
    >
