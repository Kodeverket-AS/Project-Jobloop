          ...
          <div className="grid gap-12 md:grid-cols-2">
            <div className="flex flex-col  p-6 ">
              ...
              <p className="mt-24 mb-16 ">
                ...
                arbeidsgivere. I del II av tiltaket vil deltakerne praktisere
                sine ferdigheter i praksis hos relevante arbeidsgivere. Våre
                veiledere fortsetter å bistå med faglig støtte og spisset
            ...
            <div className="flex flex-col  p-6  ">
              ...
              <p className="mt-10 mb-12 ">
                Undervisningen kombinerer tradisjonell undervisning med digitale
                læringsverktøy og prosjektarbeid og tilpasses også enkelte
                deltakers nivå og utvikling. Gjennom del I av tiltaket vil
                deltakerne tilegne seg den faglige og sosiale kompetansen de
                trenger for å kvalifisere seg til praksisarbeid innen front-end,
                systemdrift, back-end, eller UX design.
              </p>
              <ExternalLinkButton
                Path="https://gløde.no"
                Text="Les mer"
            ...
            <div className="flex flex-col  p-6  ">
              ...
              <p className="mt-10 mb-12 ">
                ...
                bak selskapet deler mange av de samme verdiene som driverne bak
                JobLoop og selskapene har drevet frem flere
                innovasjonsprosjekter sammen. Noen har resultert i offentlige
                rammeavtaler som JobLoop og Podium har levert sammen med mål om
                å hjelpe flere inn i et norsk arbeids- og samfunnsliv som stadig
                er i endring.
              </p>
              <ExternalLinkButton
            ...
            <div className="flex flex-col  p-6  ">
              ...
              <p className="mt-5 mb-12 ">
                ...
                gaming. Det har resultert i flere virksomme læringsarenaer hvor
                vi bruker spill og gaming som sosialpedagogisk arbeid med barn
                og unge og som et verktøy for læring. Sammen har vi i dag et
                ledende kompetansemiljø innen gamingpedagogikk. Dette bruker vi
                blant annet i tilbudene Spillbasert Kvalifisering, Gamify, og
                Learnwell, som alle er lærings- og mestringsarenaer med mål om å
                utvikle sosial kompetanse og arbeidslivserfaring eller å bestå
                ordinære skolefag.
              </p>
              <ExternalLinkButton
