      ...
      <section className="flex flex-col md:flex-row items-center justify-between max-w-4xl mx-auto p-4 ">
        ...
        <div className="order-1 md:order-2">
          ...
          <p className="text-lg leading-relaxed mb-6">
            Sammen med oppstartsmiljøet tilknyttet Bergen.Works coworkingspace
            har JobLoop de siste årene utviklet en alternativ plattform for
            kvalifisering og rekruttering av junior utviklere og
            innholdsprodusenter. Hensikten er å dekke det voksende
            kompetansegapet på IT-markedet og samtidig inkludere flere unge som
            har falt utenfor arbeid og utdanning. Samarbeidet ble i senere tid
            døpt “Kodehode” og videreutviklet med Arbeids- og Velferdsetaten
            NAV. I dag leveres versjoner av Kodehode som amo-tiltak i Vestland
            og Rogaland sammen med vår gode samarbeidspartner Podium.
          </p>
          <div className="mt-8">
            <LinkButton
              Path={"/kontakt"}
          ...
          <div className="grid gap-12 md:grid-cols-2">
            <div className="flex flex-col  p-6 ">
              ...
              <p className="mt-24 mb-16 ">
                ...
                kompetanseheving gjennom hele tiltakperioden.
              </p>
              <ExternalLinkButton
      ...
      <section className="py-16 ">
        <div className="container mx-auto px-4 flex flex-col lg:flex-row items-center lg:items-start">
          ...
          <div className="flex flex-col items-center lg:items-start text-center lg:text-left max-w-lg  px-12">
            ...
            <p className="mb-8">
              Karl Haakon hos oss er ansvarlig for markedsteamet i Kodehode. Han
              sitter klar med kaffen og refresher innboksen sin på
              <a
