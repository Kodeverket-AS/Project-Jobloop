...
export default function Nyhetsbrev({text, link, icon}) {
  ...
  return (
    <main className="w-full flex flex-col items-center justify-center min-h-screen p-0 pb-24 pt-20 lg:pt-0">
      ...
      <div className="w-full flex flex-col lg:flex-row gap-10 p-16 justify-center">
          ...
          <SocialMediaCard text="Instagram" link ="https://www.instagram.com/jobloop.norge/" icon={<Image src={Instagram} className="min-w-16 min-h-16 max-w-16 max-h-16"/>}/>
      </div>
    </main>
  )
}
