      ...
      <main className='max-w-[1536px] px-4 py-16 flex flex-col items-center gap-16 w-full mx-auto'>
        <section className='bg-gradient-to-b from-[#002B49] to-[#001f35] text-white py-16 px-5 w-full rounded-2xl text-center relative overflow-hidden'>
          ...
          <div className='max-w-4xl mx-auto relative z-10'>
            <h1 className='text-4xl md:text-5xl font-bold mb-6 animate-fade-in-up delay-100'>
              Nytt pilottilbud for kunder av Gjensidige
            </h1>
        ...
        <section className='bg-white py-16 px-5 w-full rounded-2xl'>
          <div className='max-w-4xl mx-auto text-center'>
            <h2 className='text-3xl md:text-4xl font-bold text-[#002B49] mb-6 animate-fade-in-up delay-100'>
              Hvilket spor passer for deg?
            </h2>
            ...
            <div className='grid lg:grid-cols-3 gap-8'>
              <div className='bg-white border border-gray-200 rounded-xl shadow-lg hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 overflow-hidden animate-fade-in-up delay-100 group'>
                ...
                <div className='p-6'>
                  ...
                  <h3 className='text-2xl font-bold text-[#002B49] mb-4 group-hover:text-[#4AB5A3] transition-colors duration-300'>
                    Stå i skolen
                  </h3>
                  <p className='text-[#555] mb-4 leading-relaxed'>
                    <strong>Konsept for utdanning:</strong> For deg som går på ungdomsskolen, men
                    hvor hverdagen er tung og fraværet øker.
                  </p>
                  <p className='text-[#555] mb-4 leading-relaxed text-sm'>
                    Vi bruker gaming og teknologi pedagogisk for å gi deg mestringsopplevelser. Du
                    er hos oss 1–2 dager i uken som et avbrekk, mens vi samarbeider tett med skolen
                    din.
                  </p>
                  <ul className='list-disc pl-5 space-y-2 text-[#444] text-sm'>
                    <li className='hover:text-[#4AB5A3] transition-colors duration-200'>
                      Finn motivasjon gjennom interesse
                    </li>
                    <li className='hover:text-[#4AB5A3] transition-colors duration-200'>
                      Sosial trening i trygge rammer
                    </li>
                    <li className='hover:text-[#4AB5A3] transition-colors duration-200'>
                      Mål: Trives bedre og fullføre 10. trinn
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className='bg-white border border-gray-200 rounded-xl shadow-lg hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 overflow-hidden animate-fade-in-up delay-200 group'>
                ...
                <div className='p-6'>
                  ...
                  <p className='text-[#555] mb-4 leading-relaxed'>
                    <strong>Konsept for utdanning:</strong> For deg som har falt ut av videregående,
                    eller trenger en annen arena for å fullføre.
                  </p>
                  <p className='text-[#555] mb-4 leading-relaxed text-sm'>
                    Dette er en alternativ læringsarena. Her kan du jobbe med fagene dine, få
                    leksehjelp eller lese til privatisteksamen i ditt eget tempo, uten stresset fra
                    et klasserom.
                  </p>
                  <ul className='list-disc pl-5 space-y-2 text-[#444] text-sm'>
                    <li className='hover:text-[#4AB5A3] transition-colors duration-200'>
                    ...
                    <li className='hover:text-[#4AB5A3] transition-colors duration-200'>
                      Fokus på enkeltfag eller vitnemål
                    </li>
                    <li className='hover:text-[#4AB5A3] transition-colors duration-200'>
                      Vi samarbeider med OT/Skole
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className='bg-white border border-gray-200 rounded-xl shadow-lg hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 overflow-hidden animate-fade-in-up delay-300 group'>
                <div className='relative w-full overflow-hidden rounded-t-xl border-t-[6px] border-t-[#4AB5A3] aspect-video bg-[#27ae60] transition-transform duration-500'>
                  ...
                  <span className='text-white text-xs absolute bottom-3 left-4 z-10 opacity-90'>
                    Video kommer snart
                  </span>
                </div>
                <div className='p-6'>
                  ...
                  <h3 className='text-2xl font-bold text-[#002B49] mb-4 group-hover:text-[#4AB5A3] transition-colors duration-300'>
                    Jobb og IT-kompetanse
                  </h3>
                  <p className='text-[#555] mb-4 leading-relaxed'>
                    <strong>Konsept for arbeid:</strong> For deg som står utenfor skole og jobb, og
                    vil lære praktisk koding, design eller IT.
                  </p>
                  <p className='text-[#555] mb-4 leading-relaxed text-sm'>
                    Her får du praktisk opplæring i ferdigheter bedriftene trenger. Vi fokuserer på
                    &quot;tech&quot; og kreativitet som døråpner til arbeidslivet.
                  </p>
                  <ul className='list-disc pl-5 space-y-2 text-[#444] text-sm'>
                    <li className='hover:text-[#4AB5A3] transition-colors duration-200'>
                      Lær koding, design og utvikling
                    </li>
                    <li className='hover:text-[#4AB5A3] transition-colors duration-200'>
                      Praksis i samarbeidsbedrifter
                    </li>
                    <li className='hover:text-[#4AB5A3] transition-colors duration-200'>
                      Veien mot lærlingplass eller jobb
                    </li>
                  </ul>
                </div>
              </div>
        ...
        <section className='bg-white py-16 px-5 w-full rounded-2xl'>
          <div className='max-w-4xl mx-auto'>
            <h2 className='text-3xl md:text-4xl font-bold text-[#002B49] mb-12 text-center animate-fade-in-up delay-100'>
            ...
            <div className='space-y-8'>
              <div className='border-b border-gray-200 pb-6 hover:border-[#4AB5A3] transition-colors duration-300 animate-fade-in-up delay-100 group'>
                <h3 className='text-xl font-bold text-[#002B49] mb-3 group-hover:text-[#4AB5A3] transition-colors duration-300'>
                  Koster det noe å være med?
                </h3>
                <p className='text-[#555] leading-relaxed'>
                  Nei. For deg som får plass gjennom dette pilotprosjektet med Gjensidige, er hele
                  tilbudet dekket av forsikringen din.
                </p>
              </div>
              ...
              <div className='border-b border-gray-200 pb-6 hover:border-[#4AB5A3] transition-colors duration-300 animate-fade-in-up delay-200 group'>
                <h3 className='text-xl font-bold text-[#002B49] mb-3 group-hover:text-[#4AB5A3] transition-colors duration-300'>
                  Er dette behandling eller terapi?
                </h3>
                <p className='text-[#555] leading-relaxed'>
                  Nei. JobLoop er en lærings- og mestringsarena, ikke en klinikk. Vi fokuserer på
                  dine interesser og styrker, ikke på diagnoser. Men vi tilpasser oss selvfølgelig
                  hvis du har utfordringer som angst eller ADHD.
                </p>
              </div>
              ...
              <div className='border-b border-gray-200 pb-6 hover:border-[#4AB5A3] transition-colors duration-300 animate-fade-in-up delay-300 group'>
                <h3 className='text-xl font-bold text-[#002B49] mb-3 group-hover:text-[#4AB5A3] transition-colors duration-300'>
                  Må jeg være supergod i gaming eller koding?
                </h3>
                <p className='text-[#555] leading-relaxed'>
                  Absolutt ikke! Det viktigste er at du har en interesse for det digitale. Vi
                  tilpasser nivået til akkurat der du er, enten du er nybegynner eller har holdt på
                  lenge.
                </p>
              </div>
              ...
              <div className='border-b border-gray-200 pb-6 hover:border-[#4AB5A3] transition-colors duration-300 animate-fade-in-up delay-400 group'>
                <h3 className='text-xl font-bold text-[#002B49] mb-3 group-hover:text-[#4AB5A3] transition-colors duration-300'>
                  Mister jeg plassen min på skolen?
                </h3>
                <p className='text-[#555] leading-relaxed'>
                  Nei. Spesielt for &quot;Konsept for utdanning&quot; samarbeider vi tett med skolen
                  din slik at du beholder elevstatusen din. Målet vårt er å hjelpe deg å fullføre.
                </p>
              </div>

              <div className='pb-6 animate-fade-in-up delay-500 group'>
                <h3 className='text-xl font-bold text-[#002B49] mb-3 group-hover:text-[#4AB5A3] transition-colors duration-300'>
                  Hva skjer hvis jeg ikke tør å møte opp fysisk?
                </h3>
                <p className='text-[#555] leading-relaxed'>
                  Vi har full forståelse for at dørstokkmila kan være lang. Derfor kan vi starte
                  digitalt via Discord eller Teams, slik at du blir trygg på veilederen din før du
                  møter oss fysisk.
                </p>
              </div>
            </div>
        ...
        <section className='bg-[#EBF2F6] py-16 px-5 w-full rounded-2xl relative overflow-hidden'>
          ...
          <div className='max-w-4xl mx-auto text-center relative z-10'>
            ...
            <div className='mb-8 p-6 bg-white rounded-xl shadow-md border-2 border-[#4AB5A3] hover:shadow-xl hover:border-[#3a9a8a] transition-all duration-500 animate-fade-in-up delay-200 group'>
              <p className='text-[#555] mb-4 leading-relaxed'>
                <strong className='text-[#002B49] group-hover:text-[#4AB5A3] transition-colors duration-300'>
                  Usikker på om dette er noe for deg?
                </strong>
              </p>
              <p className='text-[#555] mb-6 leading-relaxed'>
                Vi har laget en guide som hjelper deg å forberede deg på samtalen. Her kan du lese
                mer om hva vi snakker om, og hva det kan være nyttig å tenke over på forhånd.
              </p>
              <Link
