          ...
          <div className='omoss w-full  text-kv-black  mx-auto'>
            <div className='w-full space-y-8'>
              ...
              <p className='text-base md:text-xl font-bold md:leading-loose xl:leading-loose'>
                ...
                coworkingspace hvor modellen blant annet ble tilpasset for
                &quot;de nye jobbene&quot; innen IT-utvikling og kreativ
                teknologi, samt gründer- og vekstselskapene.
              </p>

              <p className='text-base md:text-xl md:leading-loose xl:leading-loose text-neutral-600 '>
                I dag er denne modellen mest kjent som &quot;Kodehode&quot; - et
                program som dyrker frem og trener opp dyktige junior-utviklere
                til jobber innen IT i tett samarbeid med bransjen selv. Driverne
                bak selskapet har alltid vært opptatt av å tilpasse modellene
                for de som ikke har lyktes helt i første sving, eller som står i
                fare for å falle fra sine utdanningsløp. Det har resultert i
              ...
              <div className='w-full lg:w-2/5 flex flex-col justify-center float-left mr-8 mb-4'>
                <div className='relative shadow-lg shadow-jobloop-secondary-orange/15 flex flex-col gap-4 bg-jobloop-primary-orange/5 border border-jobloop-primary-orange p-6 rounded-xl mb-6'>
                  ...
                  <p className='text-base lg:text-xl md:leading-loose text-center text-pretty'>
                    ...
                    videregående skole, og voksne arbeidssøkere. Samtidig er vi
                    tett på arbeidsmarkedet og spisser programmene våre
                    kontinuerlig etter trender og behov. Vi heier på norsk
                    IT-bransje og mener inkludering og alternative
                    kvalifiseringsmodeller vil være avgjørende for å lykkes med
                    å dekke det voksende kompetansegapet.
                  </p>
                </div>
              </div>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-4 auto-rows-fr'>
            <div className='group flex flex-col w-full gap-4 lg:gap-6 xl:flex-row-reverse bg-white rounded-xl shadow-xs hover:shadow-md border border-gray-50 p-6 transition-all duration-200 justify-between'>
              ...
              <div className='flex flex-col w-full gap-4 xl:w-1/2 justify-center'>
                ...
                <p className='text-base text-gray-600 md:text-lg leading-relaxed text-pretty'>
                  Underveis i opplæringsløpet kobles deltakerne med relevante
                  arbeidsgivere. Våre veiledere fortsetter å bistå med faglig
                  støtte og spisset kompetanseheving gjennom hele
                  tiltaksperioden.
                </p>
                <div className='pt-2'>
            ...
            <div className='group flex flex-col w-full gap-4 lg:gap-6 xl:flex-row-reverse bg-white rounded-xl shadow-xs hover:shadow-md border border-gray-50 p-6 transition-all duration-200 justify-between'>
              ...
              <div className='flex flex-col w-full gap-4 xl:w-1/2 justify-center'>
                ...
                <p className='text-base text-gray-600 md:text-lg leading-relaxed text-pretty'>
                  Undervisningen kombinerer tradisjonell undervisning med
                  digitale læringsverktøy og prosjektarbeid. Gjennom tiltaket
                  tilegner deltakerne seg faglig og sosial kompetanse for
                  praksisarbeid innen IT.
                </p>
                <div className='pt-2'>
            ...
            <div className='group flex flex-col w-full gap-4 lg:gap-6 xl:flex-row-reverse bg-white rounded-xl shadow-xs hover:shadow-md border border-gray-50 p-6 transition-all duration-200 justify-between'>
              ...
              <div className='flex flex-col w-full gap-4 xl:w-1/2 justify-center'>
                ...
                <p className='text-base text-gray-600 md:text-lg leading-relaxed text-pretty'>
                  Podium er en tiltaksbedrift med hovedkontor i Oslo. Gründerne
                  bak selskapet deler mange av de samme verdiene som JobLoop og
                  har drevet frem flere innovasjonsprosjekter sammen.
                </p>
                <div className='pt-2'>
            ...
            <div className='group flex flex-col w-full gap-4 lg:gap-6 xl:flex-row-reverse bg-white rounded-xl shadow-xs hover:shadow-md border border-gray-50 p-6 transition-all duration-200 justify-between'>
              ...
              <div className='flex flex-col w-full gap-4 xl:w-1/2 justify-center'>
                ...
                <p className='text-base text-gray-600 md:text-lg leading-relaxed text-pretty'>
                  Playwell er et Gamingsenter som driver med e-sport og sosial
                  gaming. Vi samlokaliserte oss i 2019 med mål om å utvikle
                  mestringsarenaer for sårbare barn og unge som motiveres av
                  gaming.
                </p>
                <div className='pt-2'>
        ...
        <div className='container mx-auto px-4 flex flex-col lg:flex-row items-center lg:items-start'>
          ...
          <div className='flex flex-col items-start text-left max-w-lg'>
            ...
            <p className='text-lg leading-relaxed mb-8 text-pretty'>
              ...
              alt om Kodehode og Kim om våre Spillbaserte tilnærminger.
              Karl-Håkon hjelper deg i gang med Medarbeiderskap. Du kan også se
