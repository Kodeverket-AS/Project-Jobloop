...
export default function LeaderSection({ content, leader, position }) {
    ...
    if (hasMultipleLeaders) {
        return (
            <div className='flex flex-col space-y-16 px-8 md:px-12 lg:px-24 2xl:max-w-[1600px]'>
                <div>
                ...
                {content.courseLeaders.map((courseLeader, index) => (
                    ...
                    >
                        ...
                        <div className='flex flex-col gap-4 w-full md:w-1/2 justify-center md:pl-3'>
    ...
    return (
        <div className='flex flex-col gap-6 px-8 lg:flex-row lg:gap-12 2xl:max-w-[1600px]'>
