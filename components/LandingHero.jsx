  ...
  return (
    <>
      <div className="w-screen h-4/5 relative overflow-hidden">
        ...
        <div className=" h-full flex flex-col gap-4 md:gap-6 items-center max-w-md md:max-w-xl lg:max-w-2xl xl:max-w-3xl 2xl:max-w-4xl pl-4 pr-4 md:pr-0 md:pl-8 py-32 lg:py-48 2xl:py-56">
