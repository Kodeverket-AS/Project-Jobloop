...
export default function LandingHero() {
  return (
    <>
      <div className="w-screen h-5/6 relative overflow-hidden">
        ...
        <div className="w-full bg-neutral-800/20 backdrop-blur-sm mx-auto justify-center flex flex-col gap-4 md:gap-6 items-center px-4 py-32 lg:py-48">
          <div className="pb-4 text-center max-w-3xl">
            <h1 className="pb-6 text-3xl xs:text-4xl text-kv-white lg:text-4xl xl:text-5xl 2xl:text-6xl">
